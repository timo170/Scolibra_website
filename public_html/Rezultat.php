...
<body>
    ...
    <?php
        ...
        $query="select * from carte  where Id like '%{$keyword}%' OR Titlu like '%{$keyword}%' OR Autor like '%{$keyword}%' OR Editura like '%{$keyword}%'";
        ...
        {   
            while($row = mysqli_fetch_assoc($result)) 
            {
                ...
                if($i%3==0)
                    echo '<div class="row">';
                echo
                    '<div class="col-sm-5 offset-sm-1 col-md-3 offset-md-'.$offset.' col-lg-3 text-center w3-card-8 w3-dark-grey">
                        <a href="'.$description.'">
